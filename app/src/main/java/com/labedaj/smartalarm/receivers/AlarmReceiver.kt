package com.labedaj.smartalarm.receivers
...
import com.labedaj.smartalarm.services.MediaPlaybackService
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == "com.labedaj.alarm.action.START_ALARM") {
